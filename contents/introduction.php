...
<head>
	...
	<title>Aimy Kohli >> WEB250 >> Sweet Paradise >> Introduction</title>
</head>
		...
		<section>
			...
			<figcaption>Shopping in the mall!</figcaption></figure>
			 ...
			 <ul>
				  ...
				  <li>Academic background: I am a CCP student. I plan to graduate from high school and also hope<br>
				  to earn my Associates in Software Development degree by this May.</li>
				  <li>Background in this subject: I have always been interested in computers. I have made a few decent websites<br>
				  also spend time coding in Java. </li>
				  <li>Primary Computer Platform: I mostly use a Dell laptop with a Windows 10 system. </li>
				  <li>Courses I'm Taking & Why:
				  <ul>
						<li>CSC249-N801 - Data Structures and Algorithms - This course is required for my degree.</li>
						<li>CSC284-N801 - Emerging Comp Prog Tech - This course is required for my degree.</li>
						<li>CSC174-N801 -  Server-Side Javascript - This course is required for my degree.</li>
